...
sleep 3
echo "Lets add SSH Access to the Default SG"
SG=`aws ec2 describe-instances --instance-id $InstanceId --query 'Reservations[*].Instances[*].SecurityGroups[*].GroupId' --output text`
